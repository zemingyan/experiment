...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        writeOutputJson("/home/zemingyan/IdeaProjects/fast-unflod/src/main/resource/miserables.json", a);  //输出至d3显示
        writeOutputCluster("/home/zemingyan/IdeaProjects/fast-unflod/src/main/resource/cluster.txt", a);  //打印每个节点属于哪个簇
        writeOutputCircle("/home/zemingyan/IdeaProjects/fast-unflod/src/main/resource/circle.txt", a);   //打印每个簇有哪些节点
